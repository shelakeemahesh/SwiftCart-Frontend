...
import type { Seller } from '../data/mockDb';
...
export const SellerStore: React.FC = () => {
  ...
  if (!seller) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <p className="text-swift-mid text-sm font-bold">Loading seller store...</p>
      </div>
    );
  }
  ...
  const handleFollowToggle = () => {
    ...
    addToast(
      isFollowing ? `Unfollowed store ${seller.name}` : `Following store ${seller.name}!`,
        ...
        <div className="bg-white border border-gray-100 rounded-card p-6 shadow-modal flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-swift-mid max-w-md">{seller.description}</p>
              ...
              <div className="flex items-center gap-4 pt-1 flex-wrap text-xs text-swift-mid font-bold">
                ...
                <span>•</span>
                <span className="text-swift-dark font-mono">{followerCount.toLocaleString()} followers</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        {sellerProducts.length === 0 ? (
          <div className="bg-white border border-gray-100 rounded-card p-12 text-center text-swift-mid">
            No products found matching this filter group in this merchant&apos;s storefront.
          </div>
        ) : (
