...
const getStepDescription = (step) => {
  switch (step) {
    case "PLACED":
      return "Your order has been successfully logged on our system.";
    case "CONFIRMED":
      return "Seller has approved your order and is packaging the goods.";
    case "SHIPPED":
      return "Your package has been handed over to our courier partner.";
    case "OUT_FOR_DELIVERY":
      return "A delivery executive is bringing the package to your location.";
    case "DELIVERED":
      return "Package received. Thank you for choosing SwiftCart!";
    default:
      return "";
  }
};

const formatStepTimestamp = (timestampStr) => {
...
const formatEstDelivery = (dateStr) => {
    ...
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 pb-24 text-left">
      ...
      {loading ? (
        <div className="bg-white border border-gray-100 rounded-card p-8 shadow-card flex flex-col items-center justify-center py-20">
          ...
          <p className="text-sm text-swift-mid mt-4 font-semibold">
        ...
        <div className="bg-white border border-gray-100 rounded-card p-8 shadow-card text-center py-16">
          ...
          <h3 className="font-bold text-lg text-swift-dark">
            ...
            <div className="bg-white border border-gray-100 rounded-card p-6 shadow-card space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-50 pb-4">
                <div>
                  ...
                  <span className="font-mono font-bold text-swift-dark text-sm">
                    {order.orderId}
                  </span>
                </div>
              ...
              >
                ...
                {order.statusTimeline.map((step, idx) => (
                  ...
                  >
                    {/* Circle Indicator */}
                    <div
                      className={`absolute -left-8 md:-left-10 w-8 h-8 rounded-full border-2 flex items-center justify-center z-10 transition-all duration-300 ${
                        step.completed
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        <h4
                          className={`text-sm font-bold leading-none ${step.completed ? "text-swift-dark" : "text-gray-400"}`}
                        >
                      ...
                      <p
                        className={`text-xs mt-1.5 leading-relaxed ${step.completed ? "text-swift-mid" : "text-gray-300"}`}
                      >
            ...
            <div className="bg-white border border-gray-100 rounded-card p-6 shadow-card space-y-4">
              ...
              <div className="text-xs font-semibold text-swift-dark leading-relaxed">
                {order.deliveryAddress ? (
                  ...
                  <p className="text-swift-mid italic">
