...
const CATEGORIES = [
  {
    name: "Electronics",
    icon: "https://images.unsplash.com/photo-1498049794561-7780e7231661?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Fashion",
    icon: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Home",
    icon: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Grocery",
  ...
  {
    name: "Beauty",
    icon: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Sports",
    icon: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Toys",
    icon: "https://images.unsplash.com/photo-1537655780520-1e392edd816a?w=150&auto=format&fit=crop&q=80",
  },
  {
    name: "Books",
    icon: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=150&auto=format&fit=crop&q=80",
  },
];
...
const BRANDS = [
  {
    name: "SwiftAudio",
    logo: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=80&auto=format&fit=crop&q=80",
  },
  {
    name: "AeroRun",
    logo: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=80&auto=format&fit=crop&q=80",
  },
  {
    name: "SmartVibe",
    logo: "https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=80&auto=format&fit=crop&q=80",
  },
  {
    name: "HomeZen",
    logo: "https://images.unsplash.com/photo-1505797149-43b0069ec26b?w=80&auto=format&fit=crop&q=80",
  },
  {
    name: "OpalGlow",
    logo: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=80&auto=format&fit=crop&q=80",
  },
];
...
export const Home = () => {
  ...
  return (
    <div className="space-y-12 pb-16">
        ...
        <div className="bg-white rounded-card border border-gray-100 shadow-card p-4 md:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-gray-50 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-swift-mid">
                  Top-rated items with limited-time discount drops
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-swift-mid uppercase tracking-wide">
                Ends in:
              </span>
              <div className="flex gap-1 font-mono">
                <span className="bg-swift-orange text-white text-xs font-bold px-2 py-1 rounded">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6">
        <h3 className="font-heading font-extrabold text-xl text-swift-dark mb-1">
          Shop by Category
        </h3>
        <p className="text-xs text-swift-mid mb-6">
          Browse curated selections across our popular categories
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative z-10 p-6 flex flex-col justify-center h-full text-white max-w-[60%] space-y-2">
              <span className="text-[10px] font-bold tracking-wider uppercase bg-white/20 w-fit px-2 py-0.5 rounded">
                Ad
              </span>
              <h4 className="font-heading font-extrabold text-base sm:text-xl leading-tight">
                Premium Audio Gear
              </h4>
              <p className="text-xs opacity-90">
                Experience immersive deep-bass with top brand ANC headphones.
              </p>
          ...
          >
            ...
            <div className="relative z-10 p-6 flex flex-col justify-center h-full text-white max-w-[60%] space-y-2">
              ...
              <p className="text-xs opacity-90">
                Grab comfortable and stylistic workout shirts & sneakers.
              </p>
              <span className="text-xs font-bold underline mt-2 flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                Shop Sports Fashion
              </span>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="font-heading font-extrabold text-xl text-swift-dark">
              Trending Now
            </h3>
            <p className="text-xs text-swift-mid">
              The most popular items searched and ordered today
            </p>
          </div>
          <Link
            to="/category/Electronics"
            className="text-sm font-bold text-swift-blue hover:underline flex items-center gap-1"
          >
            <span>See All</span>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-swift-mid">
              Highest rated and most reliable goods on SwiftCart
            </p>
          </div>
          <Link
            to="/deals"
        ...
        <div className="bg-gradient-to-r from-swift-blue to-swift-blue-dark rounded-card p-8 md:p-12 text-white relative overflow-hidden shadow-card">
          ...
          <div className="relative z-10 max-w-2xl space-y-4">
            ...
            <p className="text-sm md:text-base opacity-90">
              Join thousands of merchants selling to millions of customers.
              Register in minutes with minimal documentation, low commissions,
              and 24/7 seller support.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <p className="text-xs text-swift-mid mb-6">
          Official storefronts of your favorite brands
        </p>
