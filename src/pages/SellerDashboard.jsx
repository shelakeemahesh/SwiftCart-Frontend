...
export const SellerDashboard = () => {
  ...
  const handleSaveProduct = async (e) => {
    ...
    try {
      ...
      if (editingProduct) {
        await apiClient.put(
          `/api/v1/seller/products/${editingProduct.id}`,
          payload,
        );
  ...
  const handleShipOrder = async () => {
    ...
    try {
      await apiClient.put(
        `/api/v1/seller/orders/${shipModalOrderId}/ship?trackingId=${encodeURIComponent(trackingIdInput.trim())}`,
      );
  ...
  const handleBulkStockUpdate = async () => {
    ...
    try {
      const updatePromises = entries.map(async ([id, qty]) => {
        try {
          await apiClient.put(
            `/api/v1/seller/products/${id}/stock?qty=${Number(qty)}`,
          );
          return true;
        } catch {
          return false;
  ...
  const getProductImage = (p) => p.images?.[0]?.imageUrl || FALLBACK_IMAGE;
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      badge: lowStockProducts.length + outOfStockProducts.length,
    },
  ];
    ...
    <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-8 pb-24 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-6 mb-8">
        <div>
          ...
          <h1
            id="seller-dashboard-title"
            className="font-heading font-extrabold text-2xl md:text-3xl text-swift-dark mt-1"
          >
            Seller Dashboard
          </h1>
          ...
          {sidebarItems.map((item) => (
            ...
            >
              ...
              {item.badge !== undefined && item.badge > 0 && (
                <span
                  className={`text-[9px] font-mono px-1.5 py-0.5 rounded-pill ${
                    activeTab === item.id
              ...
              {loadingStats ? (
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white border border-gray-100 rounded-card p-5 shadow-card relative overflow-hidden group hover:shadow-sm transition-shadow">
                    ...
                    <span className="text-[10px] text-swift-mid font-semibold">
                      ...
                      >
                        ...
                        <div className="w-full relative flex justify-center">
                          <div
                            ...
                            style={{
                              height: `${Math.max(heightPercent * 1.5, 8)}px`,
                            }}
                          />
                        </div>
                        <span className="text-[10px] font-bold text-swift-mid">
                          {item.month}
                        </span>
                      </div>
                    );
                      ...
                      <tbody className="divide-y divide-gray-50 font-semibold text-swift-dark">
                        {orders.slice(0, 5).map((order) => (
                          ...
                          >
                            ...
                            <td className="py-2.5">
                              <span
                                className={`inline-block text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-pill border ${getStatusBadge(order.status)}`}
                              >
                                {order.status}
                              </span>
                            </td>
                      ...
                      <tbody className="divide-y divide-gray-50">
                        {displayProducts.map((product) => (
                          ...
                          >
                              ...
                              {stockEditId === product.id ? (
                                ...
                                <button
                                  onClick={() => {
                                    ...
                                    setStockEditValue(String(product.stockQty));
                                  }}
                            ...
                            <td className="py-3 px-4">
                              <span
                                className={`inline-block text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-pill border ${
                              ...
                              <td className="py-3 px-4 text-right">
                                {(order.status === "CONFIRMED" ||
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      setShipModalOrderId(order.orderUuid);
                                      setTrackingIdInput("");
                                    }}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-white border border-red-100 rounded-card p-5 shadow-card">
                  ...
                  <p className="text-[10px] text-swift-mid mt-2">
                ...
                <div className="bg-white border border-gray-100 rounded-card shadow-card overflow-hidden">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-gray-50">
                        {[...outOfStockProducts, ...lowStockProducts].map(
                          (product) => (
                            <tr
                              key={product.id}
                              className="hover:bg-gray-50/50 transition-colors font-semibold text-swift-dark"
                            >
                              <td className="py-3 px-4">
                                <div className="flex items-center gap-3">
                                  <img
                              ...
                              <td className="py-3 px-4">
                                <span
                                  className={`inline-flex items-center px-2 py-0.5 rounded-pill text-[10px] font-bold ${getStockColor(product.stockQty)}`}
                                >
                                  {product.stockQty} units
                                </span>
                              </td>
                              <td className="py-3 px-4">
                                <span
                                  className={`text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-pill border ${
                                    product.stockQty === 0
                  ...
                  {(outOfStockProducts.length > 0 ||
                    ...
                    <div className="p-4 border-t border-gray-100 flex justify-end">
                      <button
                        ...
                        disabled={
                          bulkUpdating ||
                          Object.values(bulkStockUpdates).filter(
                            (v) => v !== "",
                          ).length === 0
                        }
                              ...
                              <div className="flex items-center gap-2">
                                <div className="w-24 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                  <div
                                    ...
                                    style={{
                                      width: `${Math.min(100, (product.stockQty / 50) * 100)}%`,
                                    }}
                                  />
                                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleProductFormChange("mrp", e.target.value)
                    }
                    placeholder="1499"
                    className="w-full px-3 py-2.5 border border-gray-200 rounded-button text-sm font-mono focus:border-swift-blue focus:outline-none focus:ring-1 focus:ring-swift-blue/20"
                  />
