...
export const ProductListing = () => {
  ...
  const [resolvedCategoryId, setResolvedCategoryId] = useState(undefined);
      ...
      try {
        ...
        if (selectedSellers.length > 0) {
          filtered = filtered.filter((p) =>
            selectedSellers.includes(p.sellerId),
          );
        }
  ...
  const handleDiscountToggle = (disc) => {
  ...
  const renderFilters = () => (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-100 pb-5">
        <h4 className="font-heading font-extrabold text-sm text-swift-dark mb-3">
          Price Range
        </h4>
        <div className="flex gap-2 mb-3">
          <div className="flex-1">
            <span className="text-[10px] text-swift-mid font-bold uppercase">
              Min Price
            </span>
            <input
              type="number"
        ...
        <div className="border-b border-gray-100 pb-5">
          ...
          <div className="max-h-40 overflow-y-auto space-y-2 pr-2">
            {filteredBrands.map((brand) => (
              <label
                key={brand}
                className="flex items-center gap-2 text-xs font-semibold text-swift-dark cursor-pointer"
              >
                <input
                  type="checkbox"
      ...
      <div className="border-b border-gray-100 pb-5">
        ...
        <div className="space-y-1.5">
          {[4, 3, 2].map((stars) => (
            ...
            >
              <span className="flex items-center gap-1">{stars}★ & above</span>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 pb-20">
      {/* Breadcrumb Header */}
      <nav
        className="text-xs font-bold text-swift-mid mb-2"
      ...
      >
        ...
        <span className="text-swift-dark capitalize">
      ...
      <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 border-b border-gray-100 pb-4 mb-6">
        <div>
          ...
          <p className="text-xs text-swift-mid mt-0.5">
            ...
            {filteredProducts.length === 1 ? "item" : "items"} found matching
            your selection
          </p>
        </div>
      ...
      <div className="flex gap-8 items-start">
        ...
        <aside className="hidden lg:block w-64 bg-white border border-gray-100 rounded-card p-6 shadow-card shrink-0 sticky top-28 max-h-[80vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-6 pb-2 border-b border-gray-50">
            <span className="font-heading font-extrabold text-sm text-swift-dark">
              Filter Options
            </span>
            <button
            ...
            <div className="text-center py-20 bg-white border border-gray-100 rounded-card p-8 flex flex-col items-center justify-center space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-swift-mid mt-1">
                  Try resetting selected filters or adjusting price limits.
                </p>
              </div>
              <button
                onClick={clearAllFilters}
                  ...
                  {isLoadingMore ? (
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 max-w-full">
                      {[1, 2, 3, 4].map((n) => (
                        <div
                          key={n}
                          className="bg-white border border-gray-100 rounded-card p-3 h-[280px] flex flex-col justify-between"
                        >
