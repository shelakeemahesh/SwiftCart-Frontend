        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                SwiftCart is India’s ultimate full-featured destination for
                high-fidelity consumer electronics, trendsetting fashion,
                organic groceries, and daily lifestyle essentials.
              </p>
              <div className="flex items-center gap-3">
                <a
                  href="#"
                  className="p-2 bg-gray-800 rounded-full hover:bg-swift-orange hover:text-white transition-colors duration-200"
                  aria-label="Facebook"
                >
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                  <Link
                    to="/info/track-order"
                    className="hover:text-swift-orange transition-colors"
                  >
                    Track Your Order
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to="/info/shipping-delivery"
                    className="hover:text-swift-orange transition-colors"
                  >
                    Shipping & Delivery Speeds
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="hover:text-swift-orange transition-colors"
                  >
                    FAQ & Customer Service Help
                  </Link>
                </li>
                <li className="pt-2 border-t border-gray-700">
                  <Link
                    to="/seller/register"
                    className="hover:text-swift-blue transition-colors font-semibold text-gray-300"
                  >
                    🚀 Sell on SwiftCart
                  </Link>
                </li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    SwiftCart Head Office, 10th Floor, Prestige Tech Park, Outer
                    Ring Road, Bangalore, India - 560103
                  </span>
                </li>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 bg-gray-900/40 p-2 rounded-card border border-gray-800">
              <span className="text-xs text-gray-500 font-bold uppercase tracking-wider px-2">
                Payments:
              </span>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono border border-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-bold">
                  VISA
                </span>
                <span className="text-[10px] font-mono border border-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-bold">
                  MC
          ...
          <div className="text-center text-xs text-gray-500 mt-12">
            © {new Date().getFullYear()} SwiftCart Commerce India Private
