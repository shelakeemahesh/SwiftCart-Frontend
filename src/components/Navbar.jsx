...
export const Navbar = () => {
  ...
  const [pincode, setPincode] = useState(
    () => localStorage.getItem("sc_pincode") || "",
  );
  const [city, setCity] = useState(
    () => localStorage.getItem("sc_city") || "India",
  );
  ...
  const handlePincodeSubmit = (e) => {
    ...
    if (/^\d{6}$/.test(tempPincode)) {
      ...
      addToast(
        `Delivery location updated to ${detectedCity} (${tempPincode})`,
        "success",
      );
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-6">
              ...
              >
                ...
                <div className="truncate">
                  <div className="text-[11px] text-swift-mid uppercase font-bold tracking-wider leading-none">
                    Deliver to
                  </div>
            ...
            <div
              ref={searchRef}
              className="hidden md:block flex-grow max-w-xl relative"
            >
                  ...
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-100 rounded-card shadow-modal overflow-hidden z-50">
                    {suggestions.categories.length > 0 && (
                      <div className="p-2 border-b border-gray-50">
                        <div className="text-[10px] uppercase font-bold text-swift-mid px-3 py-1 tracking-wider">
                      ...
                      <div className="p-2">
                        ...
                        {suggestions.products.map((p) => (
                          <button
                            key={p.id}
                            onClick={() =>
                              handleSuggestionClick("product", p.slug || p.id)
                            }
                          ...
                          >
                            ...
                            <div className="truncate">
                              <div className="text-sm font-semibold text-swift-dark truncate">
                                {p.name}
                              </div>
                              <div className="text-xs text-swift-mid font-mono">
                ...
                {showAccountDropdown && isLoggedIn && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-card shadow-modal py-1 z-50">
                    <div className="px-4 py-2 border-b border-gray-100">
                      <p className="text-xs text-swift-mid font-medium">
                        Signed in as
                      </p>
                      <p className="text-sm font-bold text-swift-dark truncate">
                        {user?.name}
                      </p>
                    </div>
                    {user?.role === "ADMIN" && (
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-xs text-swift-mid mt-0.5">
                  Select a delivery pincode to check product availability and
                  delivery speeds
                </p>
              </div>
              <button
            ...
            >
              ...
              <div className="flex-grow overflow-y-auto p-4 space-y-6">
                <div className="bg-swift-bg border border-gray-100 rounded-card p-4">
                  {isLoggedIn ? (
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <h4 className="font-bold text-sm text-swift-dark truncate">
                            {user?.name}
                          </h4>
                          <p className="text-xs text-swift-mid truncate">
                            {user?.email}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="text-center py-2 space-y-2">
                      <p className="text-xs text-swift-mid font-semibold">
                        Log in for personalized tracking, wishlist, and offers
                      </p>
                      <Link
                        to="/login"
                        onClick={() => setMobileMenuOpen(false)}
                ...
                <div className="space-y-2.5">
                  <div className="text-[10px] uppercase font-bold text-swift-mid tracking-wider px-2">
                    Merchant Center
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 border border-gray-150/60 rounded-card overflow-hidden">
                    {categories.map((category) => (
                      ...
                      >
                        <span>{category}</span>
                        <span className="text-swift-mid text-[10px]">
                          &rarr;
                        </span>
                      </Link>
                    ))}
