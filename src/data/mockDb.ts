...
export interface ProductVariant {
  type: 'color' | 'size' | 'storage' | 'color-name';
  name: string;
  options: string[];
}
...
export interface Address {
  ...
  phone: string;
  pincode: string;
  addressLine1: string; // flat/house/office
...
export interface Order {
  id: string;
  date: string;
  status: 'Ordered' | 'Dispatched' | 'Out for Delivery' | 'Delivered' | 'Returned' | 'Cancelled';
  items: OrderItem[];
  subtotal: number;
  discount: number;
...
export const MOCK_SELLERS: Seller[] = [
  {
    ...
    rating: 4.7,
    followerCount: 18450,
    description: 'Premier seller of smartphones, accessories, smart home tech, and custom computing rigs. Fulfilled directly by SwiftCart.'
  },
  {
    id: 'seller-2',
    ...
    rating: 4.3,
    followerCount: 9230,
    description: 'Modern essentials, casual streetwear, and luxury tailoring for active lifestyles.'
  },
  {
    id: 'seller-3',
    name: 'HomeZen Living',
    logo: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=150&auto=format&fit=crop&q=80',
    banner: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=1200&auto=format&fit=crop&q=80',
    rating: 4.8,
    followerCount: 6110,
    description: 'Ergonomic furnishings, intelligent kitchen solutions, and artisan home accents.'
  },
  {
    id: 'seller-4',
    ...
    rating: 4.5,
    followerCount: 11200,
    description: 'Clean skincare, organic body care, dermatologically approved cosmetics.'
  }
];
...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description: 'Active Noise Cancelling (ANC) true wireless earbuds with custom spatial audio, 30-hour battery life, and IPX7 water resistance. Features quick charging and intuitive touch controls.',
    price: 1999,
    mrp: 4999,
    discount: 60,
    images: [
    ...
    variants: [
      { type: 'color', name: 'Color', options: ['Carbon Black', 'Polar White', 'Deep Navy'] }
    ],
    reviews: createMockReviews('SwiftBuds Pro Wireless Earbuds'),
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-headphones-moving-to-the-music-34251-large.mp4'
  },
  {
    id: 'prod-2',
    name: 'AeroRun Pro Cushion Running Shoes',
    description: 'Engineered with reactive nitrogen-infused foam midsole for supreme energy return. Lightweight mesh upper delivers superior breathability for long runs.',
    price: 2499,
    mrp: 5999,
    discount: 58,
    images: [
    ...
    variants: [
      { type: 'color', name: 'Color', options: ['Crimson Red', 'Neon Lime', 'Shadow Gray'] },
  ...
  },
  {
    ...
    description: '1.43-inch Always-On AMOLED Display fitness smartwatch. Tracks SpO2, heart rate, sleep quality, and incorporates 110+ sports modes with 12-day battery life.',
    price: 3499,
    mrp: 7999,
    discount: 56,
    images: [
    ...
    variants: [
      { type: 'color', name: 'Strap Color', options: ['Obsidian Black', 'Classic Leather', 'Forest Green'] }
    ],
  ...
  },
  {
    ...
    description: 'Premium hyaluronic acid and vitamin C face serum. Locks in moisture, brightens dark spots, and reduces fine lines. Suitable for all skin types. 100% vegan.',
    price: 599,
    mrp: 1499,
    discount: 60,
    images: [
    ...
    variants: [
      { type: 'size', name: 'Pack Size', options: ['30ml', '50ml'] }
    ],
  ...
  },
  {
    ...
    description: 'High-back mesh desk chair featuring adaptive lumbar support, 3D armrests, and 135-degree recline locking mechanism. Ideal for long remote working sessions.',
    price: 8999,
    mrp: 19999,
    discount: 55,
    images: [
    ...
    variants: [
      { type: 'color', name: 'Frame Color', options: ['Slate Gray & Black', 'White & Light Gray'] }
    ],
  ...
  },
  {
    ...
    description: '100% organic Single-origin Arabica coffee beans harvested from shade-grown estates in Chikmagalur. Medium roast delivering citrus and dark cocoa notes.',
    price: 349,
    mrp: 599,
    discount: 41,
    images: [
    ...
    variants: [
      { type: 'size', name: 'Grind Type', options: ['Whole Beans', 'Filter Grind', 'French Press Grind', 'Cold Brew Grind'] }
    ],
  ...
  },
  {
    ...
    description: 'Powered by the latest Gen Intel Core i5 processor, 16GB LPDDR5 RAM, and 512GB NVMe SSD. Features a gorgeous 2.5K IPS thin-bezel screen and an ultra-thin 1.3kg aluminum chassis.',
    price: 49990,
    mrp: 69999,
    discount: 28,
    images: [
    ...
    variants: [
      { type: 'storage', name: 'Configuration', options: ['16GB RAM / 512GB SSD', '16GB RAM / 1TB SSD'] }
    ],
  ...
  },
  {
    ...
    description: 'High-torque 1000W copper motor nutrition extraction blender. Includes three leak-proof Tritan travel jars, sports lids, and dry/wet grinding stainless steel blades.',
    price: 3299,
    mrp: 6999,
    discount: 52,
    images: [
    ...
    variants: [
      { type: 'color', name: 'Base Finish', options: ['Metallic Silver', 'Matte Midnight Black'] }
    ],
  ...
  },
  {
    ...
    description: 'Ultralight gel-moisturizer enriched with 72-hour moisture lock technology. Contains nutrient-rich seaweed extract and soothing Aloe Vera. Non-sticky formula.',
    price: 399,
    mrp: 899,
    discount: 55,
    images: [
    ...
    variants: [
      { type: 'size', name: 'Weight', options: ['50g', '100g'] }
    ],
  ...
  },
  {
    ...
    description: 'Handcrafted genuine goat leather cross-body messenger bag with heavy brass accents. Accommodates laptops up to 15.6 inches. Canvas padded internal lining.',
    price: 1899,
    mrp: 4500,
    discount: 57,
    images: [
    ...
    variants: [
      { type: 'color-name', name: 'Leather Tone', options: ['Tan Brown', 'Dark Chocolate'] }
    ],
  ...
  },
  {
    ...
    description: 'Affordable, rich bass earbuds featuring Bluetooth 5.3, 20-hour playback, and IPX5 splash protection. Perfect for gym and calls.',
    price: 899,
    mrp: 2499,
    discount: 64,
    images: [
  ...
  },
  {
    ...
    description: 'Workstation laptop containing high-end OLED display, AMD Ryzen 7, 32GB DDR5 RAM, and 1TB SSD. Built for creators and developers.',
    price: 74990,
    mrp: 99999,
    discount: 25,
    images: [
...
export const MOCK_ORDERS_SEED: Order[] = [
  {
    id: 'OD-781293812',
    date: '2026-05-20',
    status: 'Delivered',
    ...
    trackingTimeline: [
      { title: 'Ordered', description: 'Order successfully placed on SwiftCart', date: '2026-05-20 14:10', completed: true },
      { title: 'Dispatched', description: 'Shipped via Delhivery Courier service', date: '2026-05-21 09:30', completed: true },
      { title: 'Out for Delivery', description: 'Assigned to delivery agent near Bellandur hub', date: '2026-05-22 10:15', completed: true },
      { title: 'Delivered', description: 'Successfully handed over to resident', date: '2026-05-22 15:45', completed: true }
    ]
  },
  {
    id: 'OD-192384712',
    ...
    trackingTimeline: [
      { title: 'Ordered', description: 'Order successfully placed on SwiftCart', date: '2026-05-29 18:22', completed: true },
      { title: 'Dispatched', description: 'Shipped from Mumbai Warehouse via SwiftExpress', date: '2026-05-30 11:45', completed: true },
      { title: 'Out for Delivery', description: 'Estimated delivery by 9:00 PM today', date: 'Pending', completed: false },
      { title: 'Delivered', description: 'Pending confirmation', date: 'Pending', completed: false }
    ]
  }
];
